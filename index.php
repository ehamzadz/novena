		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<span class="text-uppercase text-sm letter-spacing ">La télémédecine nouvelle forme d’exercice de la médecine.</span>
					<h1 class="mb-3 mt-3">JE RECHERCHE MA MALADIE</h1>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<h4 class="mb-3">HEURES DE TRAVAIL DE TELE CONSULTATION </h4>
						<ul class="w-hours list-unstyled">
		                    <li class="d-flex justify-content-between">Samedi - Vendredi :<span>6:00 - 23:00</span></li>
		                </ul>
					</div>
...
>>>>>>> d65a804ebd72c5fe5646b2f6b720b34448750902
